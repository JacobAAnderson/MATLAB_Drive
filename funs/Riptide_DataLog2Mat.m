...
% EcoMapperLog2Mat  ==========================================================================================================================================================
function Data = Riptide_DataLog2Mat(file, filters)

if nargin == 2
    [rawData, sz] = Riptide_Read_Log(file, filters);                        % Read the log with filters
else
    [rawData, sz] = Riptide_Read_Log(file);                                 % Read the log without filters
end
