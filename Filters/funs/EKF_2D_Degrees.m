...
%%
function [meanGrid, varargout] = EKF_2D(x, y, Data, varargin)
...
% fprintf('\n\nEKF: %d out of %d points caught in low pass filter \n\n',pOut,length(Data))
...
% meanGrid(~dataArea) = nan;    % Clear any readings outside of the data area
